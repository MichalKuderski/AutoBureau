...
Latest read-only staging inspection after migration run 34711543385: 99 households / 99 entitlements, 9 completed migrations / 0 rolled back, 18 forced-RLS tables / 24 policies, no `ensure_rls` trigger. The earlier 90 baseline gained three synthetic households in each of setup Preview 34708885092, deadline Preview 34710349357 and notification-foundation Preview 34711314779. The additive notification rollout accounts for the two migrations, three tables and four policies. All 17 legacy application-table counts and data fingerprints, original seven migration checksums, old RLS/policy/ownership fingerprints and role flags are unchanged across migration. The controlled confirmed identity and its one session remain intact. The new tables are empty, owned by postgres and forced-RLS. No Production access was performed.
