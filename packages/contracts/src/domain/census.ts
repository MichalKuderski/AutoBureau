import type { Item, Obligation } from "./entities.js";
 ...
 * item flagged unverified and, where a deadline is implied, a claim with **no
...
export interface CensusPrompt {
  ...
  itemName: string;
  /**
   * Present when saying yes implies a deadline exists. The claim is kept
