...
import { verifyInfrastructureIdentity } from './staging-infra-oidc.mjs';
...
const claims={iss:'https://token.actions.githubusercontent.com',aud:'sts.amazonaws.com',
  ...
  workflow_ref:'MichalKuderski/AutoBureau/.github/workflows/staging-storage.yml@refs/pull/5/merge',iat:now,exp:now+300};
